...
def build_kernel_matrix(
    ...
    if rank == root:
        ...
        q1_circ_sim = np.percentile(all_time_x + all_time_y, 25)
        profiling_dict["q1_circ_sim"] = (q1_circ_sim, "seconds")
        q3_circ_sim = np.percentile(all_time_x + all_time_y, 75)
        profiling_dict["q3_circ_sim"] = (q3_circ_sim, "seconds")
        median_product = median(all_time_vdot)
        profiling_dict["median_product"] = (median_product, "seconds")
        q1_product = np.percentile(all_time_vdot, 25)
        profiling_dict["q1_product"] = (q1_product, "seconds")
        q3_product = np.percentile(all_time_vdot, 75)
        profiling_dict["q3_product"] = (q3_product, "seconds")
