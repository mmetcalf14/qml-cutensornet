...
train_info = f"train_Nf{num_features}_r{reps}_g{gamma}_nn{nearest_neighbors}_Ntr{n_illicit}_s{data_seed}_{data_file.split('.')[0]}"
test_info = f"test_Nf{num_features}_r{reps}_g{gamma}_nn{nearest_neighbors}_Ntr{n_illicit}_s{data_seed}_{data_file.split('.')[0]}"
